...
if __name__ == '__main__':
    ...
    train_dataset = CLEVRDataset(args.json_dir, args.dataset_dir, train_trans, mode='train')
    train_loader = DataLoader(train_dataset, batch_size=args.bs, shuffle=True, num_workers=num_workers)

    test_dataset = CLEVRDataset(args.json_dir, args.dataset_dir, None, mode='test', test_json='test.json')
